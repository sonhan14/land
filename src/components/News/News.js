...
import { AllPostInfor, CheckUserOnline, fetchAccount, getBoxNews, ViewlistBox, ViewlistPost } from '../../services/api';
...
const News = (props) => {
    ...
    return (
        <>
                ...
                <Row className="news-row">
                    ...
                    <Col className="content-center" xs={6}>
                        {/* <div className="post-new">
                            ...
                            ></textarea>
                            <button onClick={() => setIsShowModalLogin(true)} className="post-new-btn">
                                Đăng bài
                            </button>
                        </div>
                            ...
                            listViewPost.map((post, index) => {
                                ...
                                return (
                                    <div
                                        className="post-item"
                                        style={{ cursor: 'pointer' }}
                                        onClick={() => handleRedirectPost(post)}
                                    >
                                                ...
                                                <div className="avatar-post">
                                                    {post.Images.length > 0 &&
                                                        post.Images.map((e, index) => (
                                                            <img src={e} alt={`Images ${index}`} key={index} />
                                                        ))}
                                                </div>
                                            ) : null}
                    ...
                    <Col className="content-right">
                        <div className="old-post-right">
                            ...
                            <div className="old-post-item">
                                <div className="old-post-avatar"></div>
            ...
            <ModalCreatePost show={isShowModalLogin} handleClose={handleClose} onPostCreated={handlePostCreated} />
        </>
    );
};
